...
class TestWaypointParsing:
    ...
    def test_parse_waypoint_lat_lon(self, gpx_with_waypoint_string):
    ...
    def test_parse_waypoint_elevation(self, gpx_with_waypoint_string):
        """Test parsing waypoint elevation."""
        gpx = GPX.from_string(gpx_with_waypoint_string)
        wpt = gpx.waypoints[0]
        assert wpt.ele == Decimal("34.5")

    def test_parse_waypoint_time(self, gpx_with_waypoint_string):
    ...
    def test_parse_waypoint_name(self, gpx_with_waypoint_string):
        """Test parsing waypoint name."""
        gpx = GPX.from_string(gpx_with_waypoint_string)
        wpt = gpx.waypoints[0]
        assert wpt.name == "Berlin"

    def test_parse_waypoint_description(self, gpx_with_waypoint_string):
        """Test parsing waypoint description."""
        gpx = GPX.from_string(gpx_with_waypoint_string)
        wpt = gpx.waypoints[0]
        assert wpt.desc == "Capital of Germany"

    def test_parse_waypoint_comment(self, gpx_with_waypoint_string):
        """Test parsing waypoint comment."""
        gpx = GPX.from_string(gpx_with_waypoint_string)
        wpt = gpx.waypoints[0]
        assert wpt.cmt == "A comment"

    def test_parse_waypoint_source(self, gpx_with_waypoint_string):
        """Test parsing waypoint source."""
        gpx = GPX.from_string(gpx_with_waypoint_string)
        wpt = gpx.waypoints[0]
        assert wpt.src == "Manual"

    def test_parse_waypoint_symbol(self, gpx_with_waypoint_string):
        """Test parsing waypoint symbol."""
        gpx = GPX.from_string(gpx_with_waypoint_string)
        wpt = gpx.waypoints[0]
        assert wpt.sym == "City"

    def test_parse_waypoint_type(self, gpx_with_waypoint_string):
        """Test parsing waypoint type."""
        gpx = GPX.from_string(gpx_with_waypoint_string)
        wpt = gpx.waypoints[0]
        assert wpt.type == "City"

    def test_parse_waypoint_fix(self, gpx_with_waypoint_string):
        """Test parsing waypoint fix type."""
        gpx = GPX.from_string(gpx_with_waypoint_string)
        wpt = gpx.waypoints[0]
        assert wpt.fix == Fix("3d")

    def test_parse_waypoint_satellites(self, gpx_with_waypoint_string):
        """Test parsing waypoint satellite count."""
        gpx = GPX.from_string(gpx_with_waypoint_string)
        wpt = gpx.waypoints[0]
        assert wpt.sat == 8

    def test_parse_waypoint_hdop(self, gpx_with_waypoint_string):
        """Test parsing waypoint horizontal dilution of precision."""
        gpx = GPX.from_string(gpx_with_waypoint_string)
        wpt = gpx.waypoints[0]
        assert wpt.hdop == Decimal("1.2")

    def test_parse_waypoint_vdop(self, gpx_with_waypoint_string):
        """Test parsing waypoint vertical dilution of precision."""
        gpx = GPX.from_string(gpx_with_waypoint_string)
        wpt = gpx.waypoints[0]
        assert wpt.vdop == Decimal("1.5")

    def test_parse_waypoint_pdop(self, gpx_with_waypoint_string):
...
class TestWaypointBuilding:
    ...
    def test_build_waypoint_basic(self, sample_waypoint):
    ...
    def test_build_waypoint_elevation(self, sample_waypoint):
    ...
    def test_build_waypoint_name(self, sample_waypoint):
    ...
    def test_build_waypoint_time_format(self, sample_waypoint):
    ...
    def test_build_waypoint_roundtrip(self, gpx_with_waypoint_string):
...
class TestWaypointCalculations:
    ...
    def test_distance_to_same_point(self, berlin_waypoint):
        """Test distance to same point is zero."""
        distance = berlin_waypoint.distance_to(berlin_waypoint)
        assert distance == pytest.approx(0.0, abs=0.01)

    def test_distance_to_nearby_point(self, berlin_waypoint, nearby_waypoint):
    ...
    def test_distance_to_distant_point(self, berlin_waypoint, munich_waypoint):
    ...
    def test_distance_is_symmetric(self, berlin_waypoint, munich_waypoint):
    ...
    def test_distance_with_custom_radius(self, berlin_waypoint, munich_waypoint):
    ...
    def test_duration_to(self, berlin_waypoint, munich_waypoint):
    ...
    def test_duration_to_no_time(self, berlin_waypoint):
    ...
    def test_speed_to(self, berlin_waypoint, nearby_waypoint):
    ...
    def test_gain_to_uphill(self, berlin_waypoint, munich_waypoint):
    ...
    def test_gain_to_downhill(self, munich_waypoint, berlin_waypoint):
    ...
    def test_gain_to_no_elevation(self, berlin_waypoint):
    ...
    def test_slope_to(self, berlin_waypoint, nearby_waypoint):
...
class TestWaypointCreation:
    ...
    def test_create_empty_waypoint(self):
    ...
    def test_create_waypoint_with_attributes(self):
...
class TestWaypointRepresentation:
    ...
    def test_waypoint_repr(self, sample_waypoint):
