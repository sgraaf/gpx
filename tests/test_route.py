...
class TestRouteParsing:
    ...
    def test_parse_route_name(self, gpx_with_route_string):
        """Test parsing route name."""
        gpx = GPX.from_string(gpx_with_route_string)
        rte = gpx.routes[0]
        assert rte.name == "City Tour"

    def test_parse_route_description(self, gpx_with_route_string):
        """Test parsing route description."""
        gpx = GPX.from_string(gpx_with_route_string)
        rte = gpx.routes[0]
        assert rte.desc == "A tour of the city"

    def test_parse_route_comment(self, gpx_with_route_string):
        """Test parsing route comment."""
        gpx = GPX.from_string(gpx_with_route_string)
        rte = gpx.routes[0]
        assert rte.cmt == "Best route"

    def test_parse_route_source(self, gpx_with_route_string):
        """Test parsing route source."""
        gpx = GPX.from_string(gpx_with_route_string)
        rte = gpx.routes[0]
        assert rte.src == "Planned"

    def test_parse_route_number(self, gpx_with_route_string):
        """Test parsing route number."""
        gpx = GPX.from_string(gpx_with_route_string)
        rte = gpx.routes[0]
        assert rte.number == 1

    def test_parse_route_type(self, gpx_with_route_string):
        """Test parsing route type."""
        gpx = GPX.from_string(gpx_with_route_string)
        rte = gpx.routes[0]
        assert rte.type == "Tourism"

    def test_parse_route_points(self, gpx_with_route_string):
    ...
    def test_parse_route_point_coordinates(self, gpx_with_route_string):
    ...
    def test_parse_route_point_names(self, gpx_with_route_string):
...
class TestRouteBuilding:
    ...
    def test_build_route(self, sample_route):
        """Test building route XML."""
        element = sample_route._build()
        assert element.tag == "rte"

    def test_build_route_name(self, sample_route):
    ...
    def test_build_route_points_tag(self, sample_route):
    ...
    def test_build_route_roundtrip(self, gpx_with_route_string):
...
class TestRouteStatistics:
    ...
    def test_route_bounds(self, sample_route):
    ...
    def test_route_total_distance(self, sample_route):
        """Test route total distance calculation."""
        distance = sample_route.total_distance
        assert distance > 0

    def test_route_total_duration(self, sample_route):
    ...
    def test_route_avg_speed(self, sample_route):
        """Test route average speed calculation."""
        speed = sample_route.avg_speed
        assert speed > 0

    def test_route_elevations(self, sample_route):
    ...
    def test_route_total_ascent(self, sample_route):
        """Test route total ascent."""
        ascent = sample_route.total_ascent
        assert ascent >= Decimal("0")

    def test_route_total_descent(self, sample_route):
...
class TestRouteSequence:
    ...
    def test_route_delitem(self, sample_route):
...
class TestRouteCreation:
    ...
    def test_create_route_with_points(self, sample_waypoints_for_track):
    ...
    def test_route_with_links(self, sample_route, sample_link):
